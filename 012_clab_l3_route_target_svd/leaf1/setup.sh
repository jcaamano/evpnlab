...
ip link set redbr address aa:bb:cc:00:00:64 addrgenmode none # set L3VNI devices to routermac and no address
...
ip link set bluebr address aa:bb:cc:00:00:64 addrgenmode none # set L3VNI devices to routermac and no address
# create vrf and attch bridge port and host link
