...
# host_l3_1
ip addr add 192.169.10.1/24 dev eth4
...
ip link set vlan10 address aa:bb:cc:00:00:64 addrgenmode none # set L3VNI devices to routermac and no address
...
ip link set vlan11 addr aa:bb:cc:00:01:64 # unique MAC per L2VNI+VTEP combo (or use anycast MAC, see below)
...
ip link set vlan12 addr aa:bb:cc:00:02:64 # unique MAC per L2VNI+VTEP combo (or use anycast MAC, see below)
